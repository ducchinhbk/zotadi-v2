    ...
    $.fn.extend({
        ...
        akordeon: function (options) {
            ...
            return this.each(function () {
                ...
                var expandListenner = function (item) {
                };
                if (settings.expandListener != null && settings.expandListener != undefined) {
                    expandListenner = settings.expandListener;
                }
                ...
                function expandItem(item) {
                    isPassThrough = expandListenner(item);
