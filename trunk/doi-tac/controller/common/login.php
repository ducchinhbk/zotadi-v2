...
class ControllerCommonLogin extends Controller { 
	...
	public function index() { 
		...
		if ($this->partner->isLogged() && isset($this->request->get['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
	...
	protected function validate() {
		...
		if (!isset($this->request->post['username']) || !isset($this->request->post['password']) || !$this->partner->login($this->request->post['username'], $this->request->post['password'])) {
