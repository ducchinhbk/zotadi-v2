...
class ControllerCommonHome extends Controller {   
	public function index() {
		...
		$this->data['total_order'] = $this->model_sale_order->getTotalOrders('',$partner_id);
		...
		$results = $this->model_sale_order->getOrders($data, $partner_id);
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('sale/order/info', 'token=' . $this->session->data['token'] . '&order_id=' . $result['custom_tour_order_id'], 'SSL')
			);
	...
	public function login() {
		...
		if (!$this->partner->isLogged() && !in_array($route, $ignore)) {
	...
	public function permission() {
		if (isset($this->request->get['route'])) {
			...
			/*if (!in_array($route, $ignore) && !$this->partner->hasPermission('access', $route)) {
