          ...
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'pd.name') { ?>
                <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>">Deal name</a>
                <?php } else { ?>
                <a href="<?php echo $sort_name; ?>">Deal name</a>
                <?php } ?></td>
...
function filter() {
	url = 'index.php?route=catalog/deal&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/deal/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
