        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'pd.name') { ?>
                <a href="<?php echo $sort_tripname; ?>" class="<?php echo strtolower($order); ?>">Itinerary name</a>
                <?php } else { ?>
                <a href="<?php echo $sort_tripname; ?>">Itinerary name</a>
                <?php } ?></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="left"><?php echo $order['itinerary_name']; ?></td>
...
function filter() {
	url = 'index.php?route=sale/toorder&token=<?php echo $token; ?>';
