...
class ControllerCatalogDeal extends Controller
{
    ...
    public function insert()
    {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_catalog_product->addDeal($this->request->post, $partner_id);
    ...
    protected function getList()
    {
        ...
        $this->data['delete'] = $this->url->link('catalog/deal/deletedeal', 'token=' . $this->session->data['token'] . $url, 'SSL');
        ...
        $product_total = $this->model_catalog_product->getTotalDeals($data, $partner_id);

        $results = $this->model_catalog_product->getDeals($data, $partner_id);
        ...
        $this->data['sort_model'] = $this->url->link('catalog/deal', 'token=' . $this->session->data['token'] . '&sort=p.model' . $url, 'SSL');
        $this->data['sort_price'] = $this->url->link('catalog/deal', 'token=' . $this->session->data['token'] . '&sort=p.price' . $url, 'SSL');
        $this->data['sort_quantity'] = $this->url->link('catalog/deal', 'token=' . $this->session->data['token'] . '&sort=p.quantity' . $url, 'SSL');
