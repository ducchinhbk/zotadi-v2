...
class ControllerTravelItinerary extends Controller
{
    public function index()
    {
        ...
        if (!isset($this->request->get['tour']))
            redirect($this->url->link('travel/custom'));
        ...
        $related_products = $this->model_catalog_product->get_related_product($language_id, $place_to_go_id);
        ...
        $this->template = 'default/template/travel/itinerary.tpl';
        $this->children = array(
            'common/header',
            'common/footer'
        );
        ...
        $this->data['redirectUrl'] = $this->url->link('travel/itinerary');
