      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-links">
          <table class="form">
            <tr>
              <td>Order ID</td>
              <td><?php echo $order_info[0]['custom_tour_order_id']; ?></td>
            </tr>
            <tr>
              <td>Customer Name: </td>
            ...
            <tr>
              <td>Trip Name: </td>
              <td><?php echo $order_info[0]['tripname']; ?></td>
            </tr>
            <tr>
              <td>Start date: </td>
              <td><?php echo date('d-m-Y',strtotime($order_info[0]['startdate'])); ?></td>
            </tr>
            <tr>
              <td>Number of days: </td>
              <td><?php echo $order_info[0]['numdate']; ?> days</td>
            </tr>
          </table>
        </div>
