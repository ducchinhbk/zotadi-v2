      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="status">
                  ...
                  <option value="4" <?php if ($status == 4) echo "selected='selected'"; ?>>Denied</option>
                </select></td>
            </tr>
            <tr>
              <td>Allow people to go with</td>
              <td><select name="go_together">
                  <option value="1" <?php if ($status == 1) echo "selected='selected'"; ?>>Allow </option>
                  <option value="0" <?php if ($status == 0) echo "selected='selected'"; ?>>Not allow</option>
                </select></td>
            </tr>
            <tr>
        ...
        <div id="tab-links">
          <table class="form">
            ...
            <tr>
              <td>&nbsp;</td>
              <td><div id="itinerary_category" class="scrollbox">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($itinerary_categories as $itinerary_category) { ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="itinerary_category<?php echo $itinerary_category['category_id']; ?>" class="<?php echo $class; ?>"><?php echo $itinerary_category['name']; ?><img src="view/image/delete.png" alt="" />
                    <input type="hidden" name="itinerary_category[]" value="<?php echo $itinerary_category['category_id']; ?>" />
                  </div>
                  <?php } ?>
                </div></td>
            </tr>                
            ...
            <tr>
              <td>&nbsp;</td>
              <td><div id="itinerary_related" class="scrollbox">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($itineraries_related as $itinerary_related) { ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="itinerary_related<?php echo $itinerary_related['product_id']; ?>" class="<?php echo $class; ?>"> <?php echo $itinerary_related['name']; ?><img src="view/image/delete.png" alt="" />
                    <input type="hidden" name="itinerary_related[]" value="<?php echo $itinerary_related['product_id']; ?>" />
                  </div>
                  <?php } ?>
                </div></td>
            </tr>
...
$('input[name=\'category\']').autocomplete({
	...
	select: function(event, ui) {
		$('#itinerary_category' + ui.item.value).remove();
		
		$('#itinerary_category').append('<div id="itinerary_category' + ui.item.value + '">' + ui.item.label + '<img src="view/image/delete.png" alt="" /><input type="hidden" name="itinerary_category[]" value="' + ui.item.value + '" /></div>');
        
		$('#itinerary_category div:odd').attr('class', 'odd');
		$('#itinerary_category div:even').attr('class', 'even');
...
$('#itinerary_category div img').live('click', function() {
	$(this).parent().remove();
...
$('input[name=\'related\']').autocomplete({
	...
	select: function(event, ui) {
		$('#itinerary_related' + ui.item.value).remove();
		
		$('#itinerary_related').append('<div id="itinerary_related' + ui.item.value + '">' + ui.item.label + '<img src="view/image/delete.png" alt="" /><input type="hidden" name="itinerary_related[]" value="' + ui.item.value + '" /></div>');

		$('#itinerary_related div:odd').attr('class', 'odd');
		$('#itinerary_related div:even').attr('class', 'even');
...
$('#itinerary_related div img').live('click', function() {
	$(this).parent().remove();
