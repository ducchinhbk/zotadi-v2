        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'o.date_added') { ?>
                <a href="<?php echo $sort_date_added; ?>" class="<?php echo strtolower($order); ?>">Date received</a>
                <?php } else { ?>
                <a href="<?php echo $sort_date_added; ?>">Date received</a>
                <?php } ?></td>
              <td class="left"><?php if ($sort == 'pd.name') { ?>
                <a href="<?php echo $sort_tripname; ?>" class="<?php echo strtolower($order); ?>">Deal name</a>
                <?php } else { ?>
                <a href="<?php echo $sort_tripname; ?>">Deal name</a>
                <?php } ?></td>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td ><input type="text" name="filter_tripname" value="<?php echo $filter_tripname; ?>"  style="text-align: right;" /></td>
            ...
            <tr>
              ...
              <td class="right"><?php echo number_format($order['total'], '0', '', '.'); ?></td>
