        ...
        <div id="tab-data">
          <table class="form">
            <tr>
              ...
              <td><input type="text" name="country" value="<?php echo $country; ?>" size="100" />
...
$('input[name=\'country\']').autocomplete({
	...
	source: function(request, response) {		
		$.ajax({
			url: 'index.php?route=customtour/country/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
